...
.strength-leaf-scene::after{content:''!important;position:absolute!important;inset:-14%!important;z-index:9!important;pointer-events:none!important;opacity:.18!important;mix-blend-mode:overlay!important;background-image:radial-gradient(circle at 17% 23%,rgba(255,255,255,.62) 0 1px,transparent 1.35px),radial-gradient(circle at 71% 64%,rgba(0,0,0,.55) 0 1px,transparent 1.45px),radial-gradient(circle at 43% 81%,rgba(255,255,255,.32) 0 .8px,transparent 1.25px),radial-gradient(circle at 86% 18%,rgba(0,0,0,.42) 0 .9px,transparent 1.3px)!important;background-size:11px 13px,17px 19px,23px 21px,29px 31px!important;animation:strengthGrainShift .72s steps(4,end) infinite!important}
@keyframes strengthGrainShift{0%{transform:translate3d(0,0,0)}25%{transform:translate3d(-2%,1%,0)}50%{transform:translate3d(1%,-2%,0)}75%{transform:translate3d(2%,2%,0)}100%{transform:translate3d(-1%,0,0)}}
